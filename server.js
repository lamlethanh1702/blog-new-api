...
import serviceAccountKey from "./blog-website-88a4d-firebase-adminsdk-fbsvc-08f9817839.json" with {type: "json"}
...
server.post('/create-blog', verifyJWT, (req, res) => {
    ...
    if(!draft){
        if(!des.length || des.length > 500){
            return res.status(403).json({ error: "You must provide blog description under 500 characters" });
        }
